...
<title>MCPORTAL-Pro网站程序安装</title>
...
<nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        <span class="navbar-brand">MCPORTAL-Pro网站程序安装</span>
      </div><!-- /.navbar-header -->
    </div><!-- /.container -->
  </nav><!-- /.navbar -->
...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">欢迎使用MCPORTAL 1.0.0 专业版</h3>
	</div>
...
echo <<<HTML
		...
		<hr/><a href="javascript:history.back(-1)"><< 返回上一页</a>
HTML;
?>
	</div>
</div>
	...
	if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
		...
		if(!$con=DB::connect($dbconfig['host'],$dbconfig['user'],$dbconfig['pwd'],$dbconfig['dbname'],$dbconfig['port'])){
			...
			elseif(DB::connect_errno()==1049)
				...
				echo '<div class="alert alert-warning">连接数据库失败，['.DB::connect_errno().']'.DB::connect_error().'<hr/><a href="javascript:history.back(-1)"><< 返回上一页</a></div>';
		}else{
